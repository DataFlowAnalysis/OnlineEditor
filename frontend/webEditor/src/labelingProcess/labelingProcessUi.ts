...
export class LabelingProcessUi extends AbstractUIExtension {
    ...
    private updateContents(): void {
        switch (this.state.state) {
            case "pending":
                return this.showPendingContents();
            case "inProgress":
                return this.showInProgressContents();
            case "done":
                return this.showDoneContents();
        }
    }
    ...
    private showInProgressContents(): void {
        ...
        nextStepButton.addEventListener("click", () => {
            ...
            this.actionDispatcher.dispatch(
                NextLabelingProcessAction.create(this.labelTypeRegistry, [
                    ...this.state.finishedLabels,
    ...
    private generateAdditionalInformation(): HTMLElement | undefined {
        ...
        if (!labelTypeValue || !isThreatModelingLabelTypeValue(labelTypeValue) || !labelTypeValue.additionalInformation)
            return;
