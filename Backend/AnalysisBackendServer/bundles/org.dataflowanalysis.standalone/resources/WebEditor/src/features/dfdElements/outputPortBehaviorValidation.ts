...
export class PortBehaviorValidator {
    ...
    private static readonly SET_REGEX =
        /^set +([A-Za-z][A-Za-z0-9_]*)\.([A-Za-z][A-Za-z0-9_]*) *= *(?: +|!|TRUE|FALSE|\|\||&&|\(|\)|[A-Za-z][A-Za-z0-9;_]*(?:\.[A-Za-z][A-Za-z0-9;_]*){2})+$/;
    ...
    private static readonly SET_REGEX_EXPRESSION_INPUTS =
        /([A-Za-z][A-Za-z0-9;_]*)\.([A-Za-z][A-Za-z0-9;_]*)\.([A-Za-z][A-Za-z0-9;_]*)/g;
    // Regex matching alphanumeric characters.
    public static readonly REGEX_ALPHANUMERIC = /[A-Za-z0-9;_]+/;
