...
var NAMED_TAG, NAME_TAG, UNMANAGED_TAG, OPTIONAL_TAG, INJECT_TAG, MULTI_INJECT_TAG, TAGGED, TAGGED_PROP, PARAM_TYPES, DESIGN_PARAM_TYPES, POST_CONSTRUCT, PRE_DESTROY, NON_CUSTOM_TAG_KEYS;
...
var init_error_msgs = __esm({
  "node_modules/inversify/es/constants/error_msgs.js"() {
    ...
    MULTIPLE_PRE_DESTROY_METHODS = "Cannot apply @preDestroy decorator multiple times in the same class";
    MULTIPLE_POST_CONSTRUCT_METHODS = "Cannot apply @postConstruct decorator multiple times in the same class";
    ASYNC_UNBIND_REQUIRED = "Attempting to unbind dependency with asynchronous destruction (@preDestroy or onDeactivation)";
    ...
    CIRCULAR_DEPENDENCY_IN_FACTORY = function(factoryType, serviceIdentifier) {
...
var tryAndThrowErrorIfStackOverflow;
var init_exceptions = __esm({
  "node_modules/inversify/es/utils/exceptions.js"() {
    init_error_msgs();
    tryAndThrowErrorIfStackOverflow = function(fn, errorCallback) {
      try {
        return fn();
      } catch (error) {
...
var init_lazy_service_identifier = __esm({
  "node_modules/inversify/es/annotation/lazy_service_identifier.js"() {
...
var __awaiter, __generator, tryGetFromScope, saveToScope, _saveToRequestScope, _saveToSingletonScope, _saveAsyncResultToSingletonScope;
var init_scope = __esm({
  "node_modules/inversify/es/scope/scope.js"() {
    ...
    tryGetFromScope = function(requestScope, binding) {
    ...
    saveToScope = function(requestScope, binding, result) {
...
var multiBindToService, ensureFullyBound, getFactoryDetails;
var init_binding_utils = __esm({
  "node_modules/inversify/es/utils/binding_utils.js"() {
    ...
    init_literal_types();
    init_factory_type();
    multiBindToService = function(container) {
    ...
    ensureFullyBound = function(binding) {
      var boundValue = null;
      switch (binding.type) {
    ...
    getFactoryDetails = function(binding) {
      switch (binding.type) {
        case BindingTypeEnum.Factory:
...
var __assign, __awaiter2, __generator2, __spreadArray2;
...
var __awaiter3, __generator3, _resolveRequest, _resolveFactoryFromBinding, _getResolvedFromBinding, _resolveInScope, _resolveBinding, _bindingActivation, _activateContainer, _activateContainerAsync, _getContainerActivationsForService, _getContainersIterator;
var init_resolver = __esm({
  "node_modules/inversify/es/resolution/resolver.js"() {
    ...
    _bindingActivation = function(context, binding, previousResult) {
      var result;
...
var ModuleActivationStore;
var init_module_activation_store = __esm({
  "node_modules/inversify/es/container/module_activation_store.js"() {
    init_lookup();
...
var __assign2, __awaiter4, __generator4, __spreadArray3, Container;
...
var init_property_event_decorator = __esm({
  "node_modules/inversify/es/annotation/property_event_decorator.js"() {
    init_metadata();
  }
});
...
var init_post_construct = __esm({
  "node_modules/inversify/es/annotation/post_construct.js"() {
    init_error_msgs();
    init_metadata_keys();
    init_property_event_decorator();
    postConstruct = propertyEventDecorator(POST_CONSTRUCT, MULTIPLE_POST_CONSTRUCT_METHODS);
  }
});

// node_modules/inversify/es/annotation/pre_destroy.js
var preDestroy;
var init_pre_destroy = __esm({
  "node_modules/inversify/es/annotation/pre_destroy.js"() {
    init_error_msgs();
    init_metadata_keys();
    init_property_event_decorator();
    preDestroy = propertyEventDecorator(PRE_DESTROY, MULTIPLE_PRE_DESTROY_METHODS);
  }
});
...
var inversify_exports = {};
__export(inversify_exports, {
...
var init_inversify = __esm({
  "node_modules/inversify/es/inversify.js"() {
    ...
    init_serialization();
    init_binding_utils();
    METADATA_KEY = metadata_keys_exports;
  }
});
...
//# sourceMappingURL=chunk-RWN4KKDG.js.map
